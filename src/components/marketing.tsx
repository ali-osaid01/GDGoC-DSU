...
export default function Marketing() {
  ...
  useEffect(() => {
    axios.get(`${BASE_URL}/teams?team=marketing`)
      .then(response => {
  ...
  return (
    <main className="flex flex-col gap-5 min-h-screen bg-white">
      ...
      <div data-aos="fade-up" className="w-full flex justify-center py-8">
        <Image src='/marketingquote.svg' className='quote-image' alt='Marketing Quote' width={800} height={200} />
      </div>
            ...
            <div key={index} className="flex pb-1 w-70 h-30 flex-col rounded-xl justify-between overflow-hidden bg-white shadow-xl">
              <div className="relative">
                ...
                <div className="flex flex-col items-center">
                  <p className="mt-5 font-bold text-xl text-md text-center text-gray-900">
                    {item.fullname}
                  </p>
